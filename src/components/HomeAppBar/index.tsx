...
export function HomeAppBar() {
  ...
  return (
    <div className="w-full flex flex-row items-center justify-between p-3 shadow-sm shadow-gray-700 overflow-hidden">
      <Link to="/">
        <AppLogo />
      </Link>
      ...
      {!isLoading && username !== null && (
        <Link to="/profile">
          <p className="ml-4 text-base font-bold text-blue-500 hover:text-blue-400">
            {username}
          </p>
        </Link>
      )}
